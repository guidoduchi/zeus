...
start "" wt.exe --window new --fullscreen new-tab --startingDirectory "%ZEUS_ROOT%" --title "Zeus 2.0.2" --suppressApplicationTitle "%ZEUS_EXE%" %*
exit /b 0

:classic_console
rem Windows Terminal is unavailable: use a maximized classic console window.
start "Zeus 2.0.2" /max "%ZEUS_EXE%" %*
